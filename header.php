 ...
 ?>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php else :?>
        <li class="nav-item">
          <a class="nav-link" href="logout_form.php">Logout</a>
        </li>
        <?php endif; ?>
      ...
      <form class="d-flex" role="search">
        <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" id ="search-item" onkeyup="search()">
        <img src="./images/search-icon.svg" alt="" srcset="">
        <!-- <button class="btn btn-outline-success" type="submit">Search</button> -->
      </form>
      <a class="nav-link" href="mycart.php"><img src="./images/icons8-shopping-cart-32.png" alt="" srcset="" style="width:35px;" > cart [<?php echo $count;?>]</a>
